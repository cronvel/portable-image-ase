...
browser: browser/PortableImageAse.js browser/PortableImageAse.min.js browser/Ase.js browser/Ase.min.js

# Build only the non-minified browser lib
dev-browser: browser/PortableImageAse.js
...
# Build the browser lib
browser/PortableImageAse.js: lib/*.js
	${BROWSERIFY} lib/Ase.js -i fs -i image-size -s PortableImageAse -o browser/PortableImageAse.js

# Build the browser minified lib
browser/PortableImageAse.min.js: browser/PortableImageAse.js
	${UGLIFY} browser/PortableImageAse.js -o browser/PortableImageAse.min.js -m

# Build the browser lib
browser/Ase.js: lib/*.js
	${BROWSERIFY} lib/Ase.js -i fs -i image-size -i portable-image -s PortableImageAse -o browser/Ase.js

# Build the browser minified lib
browser/Ase.min.js: browser/PortableImageAse.js
	${UGLIFY} browser/Ase.js -o browser/Ase.min.js -m
